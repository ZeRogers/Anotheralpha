...
const distube = new DisTube(client, {
    youtubeCookie: "SIDCC=AJi4QfGOGXWhS44zXCTZ97LvOYHQ9jy179PE5ZAZXvMqxQYOYEoQpI_Ejt0jzOeejwAlRNDM", 
    searchSongs: false, 
...
client.on("ready", () => {
    ...
    setInterval(() => {
        ...
        if (stateswitch)  client.user.setActivity(`${config.PREFIX}help | https://alphamusic.cf/`, { type: "PLAYING" });
...
try{
    ...
    if (command === "invite" || command === "add"){
        return embedbuilder(client, message, "#c219d8", "Invite this Bot!", "[`Click here`](https://alphamusic.cf/invite)   |   [`Website`](https://alphamusic.cf)   |   :heart: Thanks for inviting!")
         }
    if (command === "radio") {
    ...
    if (command === "help"  || command === "about" || command === "h" || command === "info") {
        ...
        .setURL("https://alphamusic.cf/")
        .setAuthor(message.author.tag, message.member.user.displayAvatarURL({dynamic:true}),"https://alphamusic.cf/")
       ...
       >>> \`${prefix}help\`  \`${prefix}h\`  ➖➖ *List of all Commands*
        ...
        >>> \`Youtube\`, \`Soundcloud\`, [\`More\`](https://alphamusic.cf/), ...
        `)
        .addField("***BOT BY:***",`
        >>> <@735744270195097600> \`Aspect#1506\`[\`Website\`](https://alphamusic.cf/)
        `)
        .addField("***SUPPORT:***",`
        >>> [\`Server\`](https://discord.gg/BeDVNAGc8C) | [\`Website(BETA)\`](https://alphamusic.cf/) | [\`Invite\`](https://discord.com/api/oauth2/authorize?client_id=890375797095948289&permissions=535901896513&scope=bot)
        `)
